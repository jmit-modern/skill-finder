...
class WindowsApp extends React.Component{
  constructor(props){
    super(props);
  }
    ...
    return (
      <>
        <TableRow style={useStyles.subTableHeader}>
          <TableCell><FormattedMessage id="RESULT.WINDOWSAPP" /></TableCell>
          <TableCell></TableCell>
          <TableCell></TableCell>
          <TableCell></TableCell>
        </TableRow>
        ...
        <TableRow>
          <TableCell></TableCell>
          <TableCell></TableCell>
          <TableCell align="right"><FormattedMessage id="RESULT.WINDOWSPROGRAMMER" /></TableCell>
          <TableCell align="right"> {epicData.defining_requirements.windows_programmer} </TableCell>
        </TableRow>
        ...
        <TableRow>
          ...
          <TableCell></TableCell>
          <TableCell align="right"><FormattedMessage id="RESULT.WINDOWSPROGRAMMER" /></TableCell>
          <TableCell align="right"> {epicData.implementation.windows_programmer} </TableCell>
        </TableRow>
...
export default connect(mapStateToProps, mapDispatchToProps)(WindowsApp);
