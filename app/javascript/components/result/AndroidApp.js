    ...
    return (
      <>
        <TableRow style={useStyles.subTableHeader}>
          <TableCell><FormattedMessage id="RESULT.ANDROIDAPP" /></TableCell>
          <TableCell></TableCell>
          <TableCell></TableCell>
          <TableCell></TableCell>
        </TableRow>
        ...
        <TableRow>
          <TableCell></TableCell>
          <TableCell></TableCell>
          <TableCell align="right"><FormattedMessage id="RESULT.ANDROIDPROGRAMMER" /></TableCell>
          <TableCell align="right"> {epicData.defining_requirements.android_programmer} </TableCell>
        </TableRow>
        ...
        <TableRow>
          ...
          <TableCell></TableCell>
          <TableCell align="right"><FormattedMessage id="RESULT.ANDROIDPROGRAMMER" /></TableCell>
          <TableCell align="right"> {epicData.implementation.android_programmer} </TableCell>
        </TableRow>
...
export default connect(mapStateToProps, mapDispatchToProps)(AndroidApp);
