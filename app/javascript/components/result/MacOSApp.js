...
class MacOSApp extends React.Component{
  constructor(props){
    super(props);
  }
    ...
    return (
      <>
        <TableRow style={useStyles.subTableHeader}>
          <TableCell><FormattedMessage id="RESULT.MACOSAPP" /></TableCell>
          <TableCell></TableCell>
          <TableCell></TableCell>
          <TableCell></TableCell>
        </TableRow>
        ...
        <TableRow>
          <TableCell></TableCell>
          <TableCell></TableCell>
          <TableCell align="right"><FormattedMessage id="RESULT.MACOSPROGRAMMER" /></TableCell>
          <TableCell align="right"> {epicData.defining_requirements.macos_programmer} </TableCell>
        </TableRow>
        ...
        <TableRow>
          ...
          <TableCell></TableCell>
          <TableCell align="right"><FormattedMessage id="RESULT.MACOSPROGRAMMER" /></TableCell>
          <TableCell align="right"> {epicData.implementation.macos_programmer} </TableCell>
        </TableRow>
...
export default connect(mapStateToProps, mapDispatchToProps)(MacOSApp);
