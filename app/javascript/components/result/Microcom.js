...
class Microcom extends React.Component{
  constructor(props){
    super(props);
  }
  componentDidMount(){
    ...
    return (
      <>
        ...
        <TableRow>
          <TableCell></TableCell>
          <TableCell></TableCell>
          <TableCell align="right"><FormattedMessage id="RESULT.MICROCOMPROGRAMMER" /></TableCell>
...
export default connect(mapStateToProps, mapDispatchToProps)(Microcom);
