    ...
    return (
      <>
        <TableRow style={useStyles.subTableHeader}>
          <TableCell><FormattedMessage id="RESULT.FRONTEND" /></TableCell>
          <TableCell></TableCell>
          <TableCell></TableCell>
          <TableCell></TableCell>
        </TableRow>
        ...
        <TableRow>
          <TableCell></TableCell>
          <TableCell></TableCell>
          <TableCell align="right"><FormattedMessage id="RESULT.FRONTENDARCHITECT" /></TableCell>
          <TableCell align="right"> {epicData.defining_requirements.frontend_architect} </TableCell>
        </TableRow>
        ...
        <TableRow>
          <TableCell></TableCell>
          <TableCell></TableCell>
          <TableCell align="right"><FormattedMessage id="RESULT.FRONTENDPROGRAMMER" /></TableCell>
          <TableCell align="right"> {epicData.implementation.frontend_programmer} </TableCell>
        </TableRow>
